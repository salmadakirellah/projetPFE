...
const SIDEBAR_ITEMS = [
  ...
  { name: "Engrais", icon: Package, color: "#F472B6", href: "/inventories" },
  { name: "Engrais client", icon: ShoppingBag, color: "#8B5CF6", href: "/admin/products" },
  { name: "Commande", icon: Users, color: "#EC4899", href: "/users" },
  {
    name: "Uitilisateurs",
    icon: DollarSign,
    color: "#10B981",
    href: "/users", // Href initiale pour Deliveries
    hasSubMenu: true, // Indique que "Deliveries" a un sous-menu
    subMenu: [
      { name: "Clients", href: "/sales" },
      { name: "Chauffeurs", href: "/sales1" },
    ],
  },
  { name: "Vehicules", icon: ShoppingCart, color: "#F59E0B", href: "/orders" },
  {
  ...
  { name: "Liste commandes", icon: Settings, color: "#6EE7B7", href: "/settings" },
];
